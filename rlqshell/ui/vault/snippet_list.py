...
from rlqshell.core.snippet_variables import extract_variables, resolve_variables
from rlqshell.ui.widgets.empty_state import EmptyState

logger = logging.getLogger(__name__)

_DRAG_MIME = "application/x-rlqshell-snippet-id"
...
class SnippetListView(QWidget):
    ...
    def _on_new_snippet(self) -> None:
        from rlqshell.ui.vault.snippet_editor import SnippetEditor
    ...
    def _resolve_script(self, snippet: Snippet) -> str | None:
        ...
        if variables:
            from rlqshell.ui.dialogs.snippet_variable_dialog import SnippetVariableDialog
        ...
        # Confirmation
        from rlqshell.ui.dialogs.snippet_confirm_dialog import SnippetConfirmDialog
