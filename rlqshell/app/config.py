...
from rlqshell.app.constants import APP_NAME, RESOURCES_DIR


class ConfigManager:
    """Manages application configuration stored as JSON.

    Config is loaded from ~/.rlqshell/config.json (or platform equivalent).
    ...
    def db_path(self) -> Path:
        return self._data_dir / "rlqshell.db"
