...
class HostManager:
    ...
    def create_host(self, host: Host) -> int:
        ...
        cursor = self._db.execute(
            """INSERT INTO hosts (
                ...
                rdp_smartcard, rdp_drives_enabled, rdp_printers,
                rdp_fullscreen, rdp_multimon,
            ...
            (
                ...
                host.rdp_smartcard, host.rdp_drives_enabled, host.rdp_printers,
                host.rdp_fullscreen, host.rdp_multimon,
    ...
    def _row_to_host(row: dict | object) -> Host:
        ...
        return Host(
            ...
            rdp_smartcard=bool(row["rdp_smartcard"]),
            rdp_drives_enabled=bool(row["rdp_drives_enabled"]),
            rdp_printers=bool(row["rdp_printers"]),
            rdp_fullscreen=bool(row["rdp_fullscreen"]),
            rdp_multimon=bool(row["rdp_multimon"]),
